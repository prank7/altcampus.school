    ...
    <section className='py-24 bg-royal-blue-100' id='course-details'>
      ...
      <div className='container mx-auto px-8'>
        ...
        <div className='p-8  bg-dark-blue-200'>
          ...
          <div className='md:flex md:justify-between'>
            <div className='md:w-4/6'>
              ...
              <p className='text-lg text-dark-blue-400 mb-2'>- Positioning</p>
              <p className='text-lg text-dark-blue-400 mb-2'>- Flexbox</p>
              <p className='text-lg text-dark-blue-400 mb-2'>- Typography</p>
              <p className='text-lg text-dark-blue-400 mb-2'>
            ...
            <div className='md:w-2/6'>
              <h5 className='bg-blue-200 inline-block rounded-sm tracking-normal py-1 px-2 text-sm text-dark-blue-500 mb-3 font-mukta mt-6 md:mt-0 font-mukta'>
                PROJECTS
              </h5>
              <p className='text-lg text-dark-blue-400 mb-2'>
        ...
        <div className='p-8 bg-dark-blue-100'>
          ...
          <div className='md:flex md:justify-between'>
            ...
            <div className='md:w-2/6'>
              ...
              <p className='text-lg text-dark-blue-400 mb-2'>- Calculator</p>
              <p className='text-lg text-dark-blue-400 mb-2'>
                - Chrome extension
              </p>
              <p className='text-lg text-dark-blue-400 mb-2'>- Memory Game</p>
              <p className='text-lg text-dark-blue-400 mb-2'>- TODO app</p>
              <p className='text-lg text-dark-blue-400 mb-2'>- People of GOT</p>
              <p className='text-lg text-dark-blue-400 mb-2'>
        ...
        <div className='p-8 bg-dark-blue-200'>
          ...
          <div className='md:flex md:justify-between'>
            ...
            <div className='md:w-2/6'>
              ...
              <p className='text-lg text-dark-blue-400 mb-2'>- Final Project</p>
            </div>
          </div>
        </div>
        ...
        <div className='p-8 bg-dark-blue-100'>
          ...
          <div className='md:flex md:justify-between'>
            ...
            <div className='md:w-2/6'>
              ...
              <p className='text-lg text-dark-blue-400 mb-2'>- Reddit clone</p>
              <p className='text-lg text-dark-blue-400 mb-2'>- Github finder</p>
            </div>
          </div>
        </div>
        ...
        <div className='p-8 bg-dark-blue-200'>
          ...
          <div className='md:flex md:justify-between'>
            <div className='md:w-4/6'>
              <h5 className='bg-blue-200 inline-block rounded-sm tracking-normal py-1 px-2 text-sm text-dark-blue-500 mb-3 font-mukta font-mukta'>
                TOPICS
              </h5>
        ...
        <div className='p-8 bg-dark-blue-200'>
          ...
          <div className='md:flex md:justify-between'>
            <div className='md:w-4/6'>
              ...
              <p className='text-lg text-dark-blue-400 mb-2'>- MVC Pattern</p>
              <p className='text-lg text-dark-blue-400 mb-2'>
                - Templating and Rendering Dynamic Pages
              </p>
              <p className='text-lg text-dark-blue-400 mb-2'>- Mongoose ORM</p>
              <p className='text-lg text-dark-blue-400 mb-2'>
            ...
            <div className='md:w-2/6'>
              ...
              <p className='text-lg text-dark-blue-400 mb-2'>- Shopping Cart</p>
              <p className='text-lg text-dark-blue-400 mb-2'>- Book Store</p>
            </div>
          </div>
        </div>
        ...
        <div className='p-8 bg-dark-blue-200'>
          ...
          <div className='md:flex md:justify-between'>
            ...
            <div className='md:w-2/6'>
              ...
              <p className='text-lg text-dark-blue-400 mb-2'>- Tic tac toe</p>
            </div>
          </div>
        </div>
        ...
        <div className='p-8 bg-dark-blue-200'>
          ...
          <div className='md:flex md:justify-between'>
            <div className='md:w-4/6'>
              ...
              <p className='text-lg text-dark-blue-400 mb-2'>- Why Redux?</p>
              <p className='text-lg text-dark-blue-400 mb-2'>
