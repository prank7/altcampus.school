...
function Header() {
  return (
    <header className='border-b-2 z-20 relative py-3 navbar'>
      <nav className='container flex justify-between mx-auto items-center px-6 relative z-10 container'>
        <Link href='/'>
          <a>
        ...
        <div className='nav-menu'>
          ...
          <ul className='md:flex md:items-center'>
            ...
            <li className='mb-8 md:mb-0 md:ml-10'>
              <a
                className='inline-flex content-center items-center text-xl md:text-base text-white md:text-dark-blue-300 uppercase px-12 py-4 md:px-4 md:py-1 border rounded border-green-theme-500 shadow-md  bg-green-theme-500 md:bg-transparent btn-hover tracking-wide'
            ...
            <li className='md:ml-4'>
              <a
                className='inline-flex content-center items-center text-xl md:text-base text-white px-12 py-4 md:px-4 md:py-1 rounded uppercase bg-green-theme-500 border border-green-theme-500 shadow-md btn-hover tracking-wide'
