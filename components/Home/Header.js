...
let menuItems = [{ label: '', link: '' }];

function Header() {
  return (
    <header className="border-b-2 z-20 relative py-3 navbar">
      <nav className="flex justify-between items-center relative z-10 max-w-7xl mx-auto px-4 sm:px-2">
        <Link href="/">
          <a>
        ...
        <div className="nav-menu">
          ...
          <ul className="md:flex md:items-center">
            ...
            <li className="md:ml-4">
              <a
                className="inline-flex content-center items-center text-xl md:text-base text-white font-bold px-12 py-4 md:px-4 md:py-1 rounded uppercase bg-dark-blue-600 border  shadow-md btn-hover tracking-wide"
