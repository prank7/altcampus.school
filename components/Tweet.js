...
export default function Tweet({
  ...
  return (
    <div className="rounded border border-gray-300 px-6 py-4 my-4 ">
      <div className="flex items-center">
        ...
        >
          <span
            className="flex items-center font-bold text-gray-700 text-lg leading-5 hover:underline"
            title={author.name}
          >
            {author.name}
            {author.verified ? (
      ...
      <div className="flex text-gray-700 mt-2">
        ...
        <a
          className="flex items-center text-gray-500 hover:text-red-600 transition hover:underline hover:color-red-300"
          href={likeUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
